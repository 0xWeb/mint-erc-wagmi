...
function ErcInfo({ address, data, userBalance, contract, tokenSupply, chain, supportedNetworks }) {
    return (
        <section className='hidden lg:flex flex-col justify-start items-start w-full mb-20 z-10 bg-[#1B1B1B] px-12 py-8 rounded-lg'>
            ...
            <div className='text-2xl'>
                ...
                <h4>OxToken Balance: {address && data
                    ? userBalance ? chain.id === supportedNetworks ? `${userBalance} W3T` : 'Network not supported' : 'Loading...'
